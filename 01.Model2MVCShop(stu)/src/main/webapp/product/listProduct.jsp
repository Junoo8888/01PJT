...
function fncGetProductList(){
	<%System.out.println("list JSP funtion == request.getParameter(\"searchKeyword\") ==> " + request.getParameter("searchKeyword")); %>
...
<form name="detailForm" action="/listProduct.do?menu=<%=menu %>" method="post" accept-charset="EUC-KR">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	<tr>
		...
		%>		
				<a href="/listProduct.do?page=<%=j%>&menu=<%=menu%>&searchKeyword=<%=searchVO.getSearchKeyword() %>&searchCondition=<%=searchVO.getSearchCondition()%>"><%=j %></a>
		<%
			}
		%>	
    	</td>
