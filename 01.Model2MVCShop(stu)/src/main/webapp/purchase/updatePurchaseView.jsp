...
<%-- <script>
    function updateFormAction() {
        var userId = '<%=purchaseVO.getBuyer().getUserId() %>';
        var form = document.forms["updatePurchase"];
        form.action = "/updatePurchase.do?tranNo=" + userId;
        form.submit();
    }
</script> --%>
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<input type="hidden" name="purchaseProd" value="<%=purchaseVO.getPurchaseProd()%>">
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
